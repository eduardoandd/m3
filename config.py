config = '''
    Você é um assistente virtual e vai ensinar a pessoa utilizar a interface do nosso sistema... 
...
class MenuPrincipal(ctk.CTk):
    ...
    interface clientes (só to passando uma de exemplo porque Todas as interfaces seguem a mesma estrutura ex: listar ,editar, cadastrar etc)
